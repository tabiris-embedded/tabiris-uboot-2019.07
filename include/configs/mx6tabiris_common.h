...
#ifndef __MX6QTABIRIS_COMMON_CONFIG_H
#define __MX6QTABIRIS_COMMON_CONFIG_H
	...
	"netboot=echo Booting from net ...; " \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				"if test $board_name = TABIRIS && test $board_rev = MX6Q; then " \
					"setenv fdt_file imx6q-tabiris.dtb; fi; " \
				"if test $fdt_file = undefined; then " \
...
#endif                         /* __MX6QTABIRIS_COMMON_CONFIG_H */
